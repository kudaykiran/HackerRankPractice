...
describe("sixstar", function () {
    ...
    describe('equalizeArray ', function () {
        it('should return 2 when 1,2,3,3,3 value  present', function () {
            assert.equal(utils.equalizeArray([1, 2, 3, 3, 3]), 2);
        });

        it('should return 2 when 1,2,2,3value  present', function () {
            assert.equal(utils.equalizeArray([1,2,2,3]), 2);
        });
    });
